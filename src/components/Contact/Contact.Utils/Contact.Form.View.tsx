...
const ContactFormView: FC<ContactFormProps> = ({
  showFalseAgreements,
  showFalseEmail,
  showFalseName,
  handleInputChange,
      ...
      <div className="contact__form--main">
        <form className="contactForm" action="post" name="contactForm">
          <div className="contactForm__inputWrap">
            <input onChange={handleInputChange} type="text" placeholder="Imię" id="formName" className="contactInput" />
          ...
          <div className="contactForm__inputWrap--checkbox">
            ...
            <label htmlFor="inputPrivatePolicy" className="checkbox__label">
              ...
              <a className="contactForm__link" aria-label="Polityka Prywatności" target="_blank" href="/privatePolicy">
          ...
          <div className="contactForm__inputWrap--checkbox">
            ...
            <label htmlFor="inputRODO" className="checkbox__label">
              ...
              rozumieniu ustawy z dnia 18 lipca 2002 roku o świadczenie usług drogą elektroniczną (Dz.U.2017.1219 t.j.)
              na podany adres e-mail na temat usług oferowanych przez Jakuba Tańskiego zamieszkałego Śmigiel, ul.
              Mierosławskiego 1 64-030. Zgoda jest dobrowolna i może być w każdej chwili wycofana, klikając w odpowiedni
              link na końcu wiadomości e-mail. Wycofanie zgody nie wpływa na zgodność z prawem przetwarzania, którego
              dokonano na podstawie zgody przez jej wycofaniem.
            </label>
          </div>
